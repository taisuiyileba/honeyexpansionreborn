...
public class ItemInit {
    public static final DeferredRegister.Items ITEMS = DeferredRegister.createItems(HoneyExpansion.MOD_ID);

    public static final DeferredItem<Item> HONEY_BERRIES = registerFood("honey_berries",
            new FoodProperties.Builder().nutrition(4).saturationModifier(0.4F).build());

    public static final DeferredItem<Item> SLICE_OF_HONEY_CAKE = registerFood("slice_of_honey_cake",
    ...
    public static final DeferredItem<Item> HONEY_COOKIE_SAUSAGE = registerFood("honey_cookie_sausage",
            new FoodProperties.Builder().nutrition(4).saturationModifier(0.3F).alwaysEdible().build());

    public static final DeferredItem<Item> PANCAKE = registerFood("pancake",
            new FoodProperties.Builder().nutrition(2).saturationModifier(0.1F).build());

    public static final DeferredItem<Item> HONEY_PANCAKE = registerFood("honey_pancake",
