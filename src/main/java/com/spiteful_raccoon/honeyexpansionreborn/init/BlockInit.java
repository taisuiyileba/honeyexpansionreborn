...
public class BlockInit {
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, HoneyExpansion.MOD_ID);

    public static final RegistryObject<CakeBlock> HONEY_CAKE = registerBlock("honey_cake",
    ...
    public static final RegistryObject<SlabBlock> HONEY_BRICK_SLAB = registerBlock("honey_brick_slab",
            () -> new SlabBlock(honeyBrickProperties()));

    public static final RegistryObject<StairBlock> HONEY_BRICK_STAIRS = registerBlock("honey_brick_stairs",
    ...
    public static final RegistryObject<WallBlock> HONEY_BRICK_WALL = registerBlock("honey_brick_wall",
    ...
    private static <T extends Block> RegistryObject<T> registerBlock(String name, Supplier<T> block, Supplier<Item.Properties> itemProperties) {
